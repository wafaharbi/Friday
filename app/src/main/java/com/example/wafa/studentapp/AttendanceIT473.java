...
public class AttendanceIT473 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendance_it473);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<User , AttendanceIT473.UserViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<User, AttendanceIT473.UserViewHolder>(
                User.class,
                R.layout.user_single_item,
                AttendanceIT473.UserViewHolder.class,
                mDatabase
        ) {
            @Override
            protected  void populateViewHolder(final AttendanceIT473.UserViewHolder viewHolder, User model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i = new Intent(AttendanceIT473.this, ToAttendanceIT473.class);
