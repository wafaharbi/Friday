...
public class AttendanceIT215 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendance_it215);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<User , AttendanceIT215.UserViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<User, AttendanceIT215.UserViewHolder>(
                User.class,
                R.layout.user_single_item,
                AttendanceIT215.UserViewHolder.class,
                mDatabase
        ) {
            @Override
            protected  void populateViewHolder(final AttendanceIT215.UserViewHolder viewHolder, User model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i = new Intent(AttendanceIT215.this, ToAttendanceIT215.class);
