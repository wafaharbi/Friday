...
public class AttendanceCS383 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendance_cs383);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<User , AttendanceCS383.UserViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<User, AttendanceCS383.UserViewHolder>(
                User.class,
                R.layout.user_single_item,
                AttendanceCS383.UserViewHolder.class,
                mDatabase
        ) {
            @Override
            protected  void populateViewHolder(final AttendanceCS383.UserViewHolder viewHolder, User model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i = new Intent(AttendanceCS383.this, ToAttendanceCS383.class);
