...
public class AttendanceCS214 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendance_cs214);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<User , AttendanceCS214.UserViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<User, AttendanceCS214.UserViewHolder>(
                User.class,
                R.layout.user_single_item,
                AttendanceCS214.UserViewHolder.class,
                mDatabase
        ) {
            @Override
            protected  void populateViewHolder(final AttendanceCS214.UserViewHolder viewHolder, User model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i = new Intent(AttendanceCS214.this, ToAttendanceCS214.class);
