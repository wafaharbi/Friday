...
public class AttendanceIT443 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendance_it443);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<User , AttendanceIT443.UserViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<User, AttendanceIT443.UserViewHolder>(
                User.class,
                R.layout.user_single_item,
                AttendanceIT443.UserViewHolder.class,
                mDatabase
        ) {
            @Override
            protected  void populateViewHolder(final AttendanceIT443.UserViewHolder viewHolder, User model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i = new Intent(AttendanceIT443.this, ToAttendanceIT443.class);
